 ...
 * It contains the sidebar and the main content area for nested routes.
 */
            ...
            <div className="grid grid-cols-12">
                ...
                <aside className="col-span-3 bg-surface border-r border-border-color h-screen p-6 flex flex-col">
                    ...
                    <nav className="space-y-2 flex-grow">
                        <NavLink to="/trends" icon={<ChartIcon />}>Price Trend Graph</NavLink>
                        <NavLink to="/table" icon={<TableIcon />}>Interactive Data Table</NavLink>
                    </nav>
                    {/* --- Admin & User Section --- */}
